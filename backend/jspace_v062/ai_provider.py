...
def _cached_client(api_key: str, timeout_ms: int):
    """Reuse the underlying HTTP client so each turn does not create a new connection."""
...
def probe_gemini(*, api_key: str | None, model: str = DEFAULT_MODEL, timeout_ms: int = 5000) -> tuple[bool, str]:
